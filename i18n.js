...
const T18 = {
  en: {
    ...
    n_scopri:'Discover', n_taste:'Eat & Drink', n_pianifica:'Plan', n_bottega:'Bottega', n_login:'Log in', h_ex:'Curated experiences & itineraries', h_ev:'Festivals & sagre all year round', scopri_h1:'Discover Abruzzo', scopri_lead:'Six ways to explore — experiences, mountains, villages, wellness, monuments and living traditions.',
  ...
  it: {
    ...
    n_scopri:'Scopri', n_taste:'Mangiare & Bere', n_pianifica:'Pianifica', n_bottega:'Bottega', n_login:'Accedi', h_ex:'Esperienze e itinerari curati', h_ev:'Feste e sagre tutto l\'anno', scopri_h1:'Scopri l\'Abruzzo', scopri_lead:'Sei modi per esplorare — esperienze, montagne, borghi, benessere, monumenti e tradizioni vive.',
  ...
  de: {
    ...
    n_scopri:'Entdecken', n_taste:'Essen & Trinken', n_pianifica:'Planen', n_bottega:'Bottega', n_login:'Anmelden', h_ex:'Kuratierte Erlebnisse & Routen', h_ev:'Feste und Sagre das ganze Jahr', scopri_h1:'Entdecke die Abruzzen', scopri_lead:'Sechs Wege zu entdecken — Erlebnisse, Berge, Dörfer, Wellness, Monumente und lebendige Traditionen.',
  ...
  fr: {
    ...
    n_scopri:'Découvrir', n_taste:'Manger & Boire', n_pianifica:'Planifier', n_bottega:'Bottega', n_login:'Se connecter', h_ex:'Expériences et itinéraires', h_ev:'Fêtes et sagre toute l\'année', scopri_h1:'Découvrir les Abruzzes', scopri_lead:'Six façons d\'explorer — expériences, montagnes, villages, bien-être, monuments et traditions vivantes.',
